...
import {Ping} from "lib/chainlink-local/src/test/ccip/Ping.sol";
import {Pong} from "lib/chainlink-local/src/test/ccip/Pong.sol";
import {CCIPLocalSimulatorForkUMV, Register} from "test/CCIPLocalSimulatorForkMod/CCIPLocalSimulatorForkUMV.sol";

contract PingPongForkUMV is Test {
    ...
    function test_ForkPingPong() public {
        ...
        ccipLocalSimulatorFork.switchSingleChainRouteAllDestMessages(sepoliaFork);
